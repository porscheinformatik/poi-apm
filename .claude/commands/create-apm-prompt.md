...
6. Keep only preserved frontmatter keys and fix invalid prompt structure before finishing.
7. Avoid source-tree-relative links in the body; use portable wording instead.
8. Report what changed and why, then suggest any optional concision improvements.