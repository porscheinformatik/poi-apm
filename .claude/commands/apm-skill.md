...
6. Follow the instructions in .apm/instructions/apm-skill.instructions.md to create or update the skill.
7. Keep the skill short, imperative, and scoped to the matching glob.
8. Check the result against .apm/instructions/apm-skill.instructions.md and fix any layout or frontmatter issues.